...
import {
  collectLegacyMemorySidecarBackupResources,
  collectLegacyMemorySidecarSources,
  readMemorySearchFtsTokenizer,
  readMemorySearchVectorEnabled,
  readMemorySearchVectorExtensionPath,
} from "./doctor-memory-sidecar-sources.js";
...
export const memorySidecarStateMigration: PluginDoctorStateMigration = {
  ...
  collectBackupResources: collectLegacyMemorySidecarBackupResources,
