...
Second paragraph should still reach the agent after Slack's preview cutoff.`;
  ...
  const otherMentionCases: Array<{
    ...
    {
      name: "keeps a wake-word request mentioning a human when ignoreOtherMentions=true",
      text: "<@U456> helper",
      accepted: true,
      otherIsBot: false,
    ...
    {
      name: "drops a wake-word request mentioning another bot when ignoreOtherMentions=true",
      text: "<@U456> helper",
      accepted: false,
      otherIsBot: true,
      ignoreOtherMentions: true,
