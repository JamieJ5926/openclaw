...
export const IntegrationProtocolSchemas = {
  ...
  PushLiveActivityDiscoverParams: push.PushLiveActivityDiscoverParamsSchema,
  PushLiveActivityDiscoverResult: push.PushLiveActivityDiscoverResultSchema,
  PushLiveActivityPrepareParams: push.PushLiveActivityPrepareParamsSchema,
  PushLiveActivityPrepareResult: push.PushLiveActivityPrepareResultSchema,
  PushLiveActivityRegisterParams: push.PushLiveActivityRegisterParamsSchema,
  PushLiveActivityRotateParams: push.PushLiveActivityRotateParamsSchema,
  PushLiveActivityRevokeParams: push.PushLiveActivityRevokeParamsSchema,
  PushLiveActivityRegistrationResult: push.PushLiveActivityRegistrationResultSchema,
  PushLiveActivityRevokeResult: push.PushLiveActivityRevokeResultSchema,
